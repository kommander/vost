...
Vost.prototype._createHostTarget = function(host) {
  ...
  var targetObj = {
    ...
    message503: host.message503 || null
  }
  return targetObj;
};
...
Vost.prototype._replyHostDown = function(clientSocket) {
  ...
  var message503 = clientSocket.targetSocket.targets[clientSocket.targetSocket.selectedTarget].message503 != null 
    ? clientSocket.targetSocket.targets[clientSocket.targetSocket.selectedTarget].message503
